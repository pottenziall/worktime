...
file_handler = logging.FileHandler(constants.LOG_FILE_PATH, "a", encoding="utf-8")
logging.basicConfig(
...
class App:
    def __init__(self, *, user_interface: ui.Window, db_if: WorktimeSqliteDbInterface) -> None:
    ...
    def fill_ui_with_workdays(self, limit: int = MAX_ROW_READ_LIMIT) -> None:
        result = self._db_if.read(table=Worktime, limit=limit)
